...
async function embedBuilder() {
  const tutorialEmbed = new Discord.MessageEmbed()
    ...
    .addField(
      "SolidWorks workshop",
      "https://www.youtube.com/playlist?list=PL6AO3_MiwR-Yz09_lw_u3ivDrcKFk9bJD",
    )
    .addField("LaTeX", "https://www.latex-tutorial.com/")
    .addField("Coding", "https://www.w3schools.com/")
    .addField(
      "Using Abaqus for Chassis Simulation",
      "https://drive.google.com/open?id=1sS9be25Nj2IoOwkJELR1M9gVe0-DaaQNVsUQKTJNZlc",
    )
    .setFooter(
      "If you want more tutorials added in, contact Geary or another server developer.",
    );
